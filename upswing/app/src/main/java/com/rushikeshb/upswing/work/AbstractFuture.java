...
/**
 * Copied from androidx.work.impl.utils.futures.AbstractFuture.
 */
...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
    ...
    // < --------------------------------- Diff from original begins -------------------------- !
    // Actual class uses: androidx.work.impl.utils.futures.DirectExecutor.INSTANCE. Add a specific
    // executor in SDK's implementation.
    ...
    protected boolean setFuture(ListenableFuture<? extends V> future) {
        ...
        if (localValue == null) {
            ...
            if (ATOMIC_HELPER.casValue(this, null, valueToSet)) {
                ...
                try {
                    // < --------------------------------- Diff from original starts -------------------------- !
                    future.addListener(valueToSet, EXECUTOR);
                    // < --------------------------------- Diff from original ends -------------------------- !
                } catch (Throwable t) {
